        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-display2"></i> All Enrolment
                </h2>
            </div>
        </div>
    </div>
...
<?php
$query = query("SELECT *, c.title AS c_title, DATE_FORMAT(p.date, '%b %e, %y - %l:%i %p') AS format_date FROM training_program AS p
...
var table = $('#example1').DataTable( {
        mark: true,/*
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Enrollment-'+_d, className: 'btn-sm'},
                {extend: 'pdf', title: 'Enrollment-'+_d, className: 'btn-sm'},
