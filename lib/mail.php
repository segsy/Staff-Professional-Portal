...
$mail->addBCC("epebinuoluwafemi@gmail.com", "Epebinu oluwafemi");
...
function mailFeedback($mssg,$cs,$less,$name,$subject,$e,$dept,$rank,$jobfamily){

//$mssg = html_entity_decode($mssg);

$html = file_get_contents('mailfeedback.html'); 
...
$html = str_replace('%course%', $cs, $html); 

$html = str_replace('%lesson%', $less, $html); 
...
$mail->Subject = "FeedBack Message From ".$name;
