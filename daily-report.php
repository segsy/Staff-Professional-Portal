...
include("nav-all.php");
// include"nav.php";
$_day   = isset( $_GET['day'] ) ? escape_s($_GET['day']) : '';
        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-display2"></i> <span class="text-info"><?=date('l, j F, Y', strtotime($_day))?></span> Report
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        <input type="hidden" id="record_date" name="record_date" value="<?=$_day?>" />
                                </div>
...
$(function () {
            ...
            $("#gotorecord").click(function(event) {
             ...
             window.location = 'daily-report.php?day='+gt;
