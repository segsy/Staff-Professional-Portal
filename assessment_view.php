...
<div class="container-fluid admin">
    ...
    <div class="card col-md-5" style="float:left">
        ...
        <div class="card-body">
            <ul class="list-group">
                <?php
                $qry = $conn->query("SELECT u.*,q.id as qid FROM $tbl_user u left join quiz_staff_list q on u.id = q.user_id where q.quiz_id = ".$_GET['id']." order by u.name asc");
                while($row=$qry->fetch_array()){
                    ?>
