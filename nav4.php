...
<!-- Header -->
<div id="header" style="background: #ae82d9;">
...
<!-- Navigation -->
<aside class="navbar-offcanvas navbar-offcanvas-touch" id="menu" style="background: #ae82d9;">
    <div id="navigation">
        ...
        <div class="profile-picture m-b-lg">
           ...
           <div class="profile-picture-holder">
            ...
            <?php if($_SESSION['_q_user']['_log_type'] == 'jfManager'){?>
                <div class="stats-label text-white">
                    <h4><span class="label label-primary text-white" style=""><strong>Welcome <?= $_SESSION['_q_user']['_fname'];?>!</strong></span></h4>
                    <div><span class="label label-primary text-white" style=""><strong> Job Family Manager</strong></span></div>
                </div>
            <?php } ?>
        </div>
  <!--  -->
