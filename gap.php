...
<!--                              <div class="form-group col-lg-6">
 ...
 -->
                      ...
                      <div class="col-lg-12">
                        <div class="row">  
                         <div class="form-group">
                                <label class="control-label h4 text-info">2020 CPDP Training</label>
                                <span class="help-block text-infso"></span>
                          </div>
                        </div>
                        </div>
                      ...
                      <br>
                       ...
                       <div class="col-lg-12">
                        <div class="row">                          
                          <div class="form-group col-lg-6">                                     
                                <label>(c). Did you attend any of our Onsite CPDP Training in 2020?</label>
                                <div class="col-md-12 p-none">
                                      <label class="radio-inline">
                      ...
                      <div class="col-lg-12">
                       ...
                       <div class="col-lg-12">
                        <div class="row">                          
                          <div class="form-group col-lg-6">
                          <label>(a). How would you rate your Performance on the Job in 2020. (Pls select from 1-10,1 being the lowest and 10 being the highest)</label>
                          <div class="col-md-12 p-none">
                      ...
                      <div class="col-lg-12">
                        <div class="row">  
                         <div class="form-group">
                          <label class="h4 text-info">2021 Personal Training Needs</label>
                          </div>
                        </div>
                        </div>
                      ...
                      <div class="col-lg-12">
                        <div class="row">  
                         <div class="form-group">
                                <label class="control-label">(a). What are your 5 Top Professional Training needs in 2021?
