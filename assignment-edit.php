...
$query = query("SELECT l.id, l.title, l.path, l.lesson, l.summary, l.duration, l.course_id, c.title AS c_title
                              ...
                              <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                          ...
                                          <select class="form-control input-sm" name="a_course" id="a_course" required>

                                            <option value="<?=$course_id?>"><?=$c_title?></option>
                                    ...
                                    <div class="col-sm-12">
                                     ...
                                     <select class="form-control input-sm" id="a_number" name="a_number" required>
                                            ...
                                            <option value="<?=$lesson?>">Lesson <?=$lesson?></option>
                                               ...
                                               <?php echo getLessonsNo($course_id);?>                        
