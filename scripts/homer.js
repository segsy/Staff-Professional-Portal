$(document).ready(function () {
    var _l = window.location.pathname.replace('/pcl2/training/','');
   // console.log(_l);
...
setInterval(function() {
        ...
        var wHeight = Math.floor($(window).height() - 0);
      //  console.log(wHeight);
        $("body.landing-page .screensection").height(wHeight);
    ...
    $('.hide-menu').on('click', function(event){
        ...
        //jQuery to collapse the white transparent navbar on scroll 
