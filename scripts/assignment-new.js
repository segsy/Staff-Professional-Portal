   ...
   // $('#assignmentform').on('submit', function(e) {
	...
	//	event.preventDefault();
        ...
        $.ajax({
            ...
            data: $('#assignmentform input[type=\'text\'], #assignmentform input[type=\'hidden\'], #assignmentform textarea, #assignmentform select'),

         //   data: $('#assignmentform input[type=\'text\'], #assignmentform textarea[name=\'c_code\']'),
