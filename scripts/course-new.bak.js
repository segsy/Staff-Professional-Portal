                ...
                if( json.error ) {
                 // Error messages
                    ...
                    if( json.error.subject ) {
                        $('#courseform input[name="c_subject"]').parent().addClass('has-error');
                        $('#courseform input[name="c_subject"]').next('.help-block').html('<i class="fa fa-warning"></i> ' + json.error.subject );
                    }
