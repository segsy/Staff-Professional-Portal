             ...
             <!--   -->    
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="text-center">
                                             ...
                                             <button type="submit" name="submit" class="btn btn-lg btn-info pull-left ladda-button btn-block" data-style="expand-right"> <i class="pe pe-7s-unlock"></i> SIGN IN</button>
