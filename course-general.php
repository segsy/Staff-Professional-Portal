    ...
    <div class="small-header transition animated fadeIn">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs text-primary">
                   <i class="pe pe-7s-display2"></i> View General Courses
                </h2>
...
$query = query("SELECT c.id, c.title, c.date, c.visibility, c.duration, c.category, c.status 
