...
<!-- Header -->
<div id="header" style="background: darkslateblue;">
...
<!-- Navigation -->
<aside class="navbar-offcanvas navbar-offcanvas-touch" id="menu" style="background: slateblue;">
    <div id="navigation">
  ...
  <!--  -->
        <ul class="nav" id="side-menu">
           ...
           <li> <a href="gap-list.php"> <span class="nav-label"><i class="pe pe-7s-file fa-lg"></i> Gap analyst assessment</span></a></li>
            <li>
                <a href="#"><span class="nav-label"><i class="pe pe-7s-mail-open-file fa-lg"></i> News Ticker</span> </a>
...
<!--                     <li><a href="course-categories.php"> Categories</a></li>
 -->                    
                    <li><a href="course-new.php"> New Course</a></li>
                     <li><a href="course-jobfamily.php">Job Family Courses <span class="nav-label label label-danger pull-right">New</span></a></li>
                    <li><a href="course-professional.php">Professional Courses <span class="nav-label label label-danger pull-right">New</span></a></li>
                    <li><a href="course-general.php">General Courses <span class="nav-label label label-danger pull-right">New</span></a></li> 
...
<!--             <li>
 ...
 -->
            ...
            <li>
                <a href="#"><span class="nav-label"><i class="pe pe-7s-display2 fa-lg"></i> Slides</span> </a>
                <ul class="nav nav-second-level" aria-expanded="true">
