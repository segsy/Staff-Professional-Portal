...
switch ($_a) {
    case 'new':
      ...
      if(query("INSERT INTO training_contact(subject,content,status,date,user,dept)
        VALUES('$_subject','$_code','0',NOW(),'$_id','$_dept')")){


            $mailit = mailContact($_POST['c_code'],$_name,$_subject,$_email,$_deptname,$_rank,$_jobfamilyname);

                $json['success'] = 'Contact recieved!';
        }else{
