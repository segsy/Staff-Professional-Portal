...
class Browser
{
 ...
 function osi() { 
  global $setosversion; $oses = array( 
    'Win311' => 'Win16',
...
$setosversion = strtolower($setosversion ? $setosversion : $_SERVER['HTTP_USER_AGENT']); 
foreach ($oses as $os => $pattern) if (preg_match('#' . $pattern . '#i', $setosversion)) return $os; return 'Unknown'; 
} 
$browser = new Browser();
//print_r($browser);
//die();
//define('U_URL', (isset($_GET['i']))?$_GET['i']:"blog"); 
//define('U_REFERER', (isset($_SERVER["HTTP_REFERER"]))?$_SERVER["HTTP_REFERER"]:""); 
$_ip = $_SERVER['REMOTE_ADDR']; //''
$_session = session_id(); //''
$_browser = $browser->getBrowser();
$_browserv = floor($browser->getVersion());
$_os = $browser->getPlatform();
$_osv = osi();
