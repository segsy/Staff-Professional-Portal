        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-display2"></i> Course Overview
                </h2>
            </div>
        </div>
    </div>
 ...
 // print_r($rows);
     ...
     ?>
                    ...
                    <tr class="tr<?=$c_id?>">
                      <td><?=$c_title?></td>
                      <td><?=$p_enrolled?></td>
                      <td><span class="pie"><?=$p_completed?>/<?=$p_enrolled?></span></td>
                      <td>
                      <div class="btn-group btn-group-sm pull-right">
                        <a href="enrolled-course-overview.php?i=<?=$c_id?>&n=<?=$c_title?>" class="btn btn-outline btn-success"> Overview </a>
                        <a href="enrolled-course-list.php?i=<?=$c_id?>&n=<?=$c_title?>" class="btn btn-outline btn-info"> Enrollment List </a>                                 
                        </div> 
                      </td><!--   -->
                    </tr>
