        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-display2"></i> Course Subscription
                </h2>
            </div>
        </div>
    </div>
...
<?php
$query = query("SELECT d.title, d.id, COUNT(e.id) AS count
FROM training_course AS d
LEFT JOIN training_enrollment AS e ON d.id =e.course
GROUP BY d.id
ORDER BY count DESC");
/*
     ...
     ?>
                    ...
                    <tr>
                      ...
                      <div class="btn-group btn-group-sm pull-right">
                        <a href="enroll-course-check.php?i=<?=$c_id?>&n=<?=$c_title?>" class="btn btn-outline btn-success">
                            Check Subscription </a>                                              
                        </div> 
                      </td><!--   -->
                    </tr>
