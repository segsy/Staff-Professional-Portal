        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-display2"></i> View All Slides
                </h2>
            </div>
        </div>
    </div>
...
FROM $tbl_lesson AS l
 ...
 WHERE l.type='s' ORDER By l.lesson DESC");
     ...
     ?>
                    ...
                    <tr class="tr<?=$id?>">
                      ...
                      <div class="btn-group btn-group-sm pull-right">
                        ...
                        <a href="slide-edit.php?i=<?=$id?>" class="btn btn-outline btn-info">
                        <i class="pe pe-7s-pen fa-lg"></i> Edit Slide </a>
                      </div> 
                      </td><!--   -->
                    </tr>
