        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                   <i class="pe pe-7s-user"></i> Top Ten Staff's
                </h2>
            </div>
        </div>
    </div>
...
var table = $('#example1').DataTable( {
        mark: true,/*
            ...
            buttons: [
                ...
                {extend: 'csv',title: 'Staff-top-ten-record'+_d, className: 'btn-sm'},
                {extend: 'pdf', title: 'Staff-top-ten-record'+_d, className: 'btn-sm'},
