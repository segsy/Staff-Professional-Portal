...
<head>
    ...
    <!-- Page title -->
    <title> Continous Professional Development Portal</title>
...
<div id="header">
    ...
    <div id="logo" class="light-version">
              <!-- <img class="logo" alt="Dwily" src="images/logo-color.png"> -->
                <span> <i class="pe pe-7s-study"></i>  Continous Professional Development Portal</span>
    </div>
    <nav role="navigation">
  ...
  <!--  -->
        <ul class="nav" id="side-menu">
           ...
           <?php if($_SESSION['_q_user']['_log_type'] == 'staff'){?>
            ...
            <li> <a href="my-enrollment.php"><span class="nav-label"> My Enrollment</span></a></li>
           ...
           <?php if($_SESSION['_q_user']['_log_type'] == 'manager'){?>
            ...
            <li>
                ...
                <ul class="nav nav-second-level" aria-expanded="true">
                    ...
                    <li><a href="schedule-section.php">Schedule Section</a></li>
                </ul>
            </li>
            <li>
          ...
          <?php if($_SESSION['_q_user']['_log_type'] == 'records'){?>
           <li> <a href="#dashboard.php"><span class="nav-label"> Dashboard</span></a></li> 
            ...
            <li> <a href="dept-record.php"> <span class="nav-label"> Dept. Enrollment</span></a></li>
